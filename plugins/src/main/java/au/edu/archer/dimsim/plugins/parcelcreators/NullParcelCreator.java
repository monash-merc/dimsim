...
public final class NullParcelCreator extends AbstractCreator {
	
	public Parcel createParcel(Map<String, Object> args)
			throws PluginException { return null;}

	public static AbstractCreator getNullParcelCreator() {
		return new NullParcelCreator();
	}
}
