...
public interface IRigakuFileEventListener {
	public final static String SET_NEW_SCPFILE = "set_new_scpfile";
	public final static String SCP_FILENAME = "scp_filename";
