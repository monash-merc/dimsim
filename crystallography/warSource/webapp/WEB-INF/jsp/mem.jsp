...
<%! 
public long byte2mb(long b) {
 return b / (1024 * 1024);
}
%>
<h2 align="center">JVM Memory Monitor</h2>

<table border="0" width="100%">
<tr><td colspan="2" align="center"><h3>Total Memory</h3></td></tr>
...
Reference & Acknowledgements : <A href="http://www.freshblurbs.com/explaining-java-lang-outofmemoryerror-permgen-space">Explaining java.lang.OutOfMemoryError: PermGen space</A>
