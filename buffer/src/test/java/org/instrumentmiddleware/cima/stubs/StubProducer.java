...
*/
package org.instrumentmiddleware.cima.stubs;
...
public class StubProducer extends AbstractProducer {
	 ...
	 * @throws Exception
	 */
	public StubProducer(String id, IParcelCreator creator,
			ICIMADirector director) throws Exception {
		super(id, creator, director);
	}

	public StubProducer(String id, ICIMADirector director) throws Exception {
		this(id, pCreator, director);
	}
}
